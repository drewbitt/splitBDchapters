...
def getLength(filename):
    """Returns length of file to the milisecond using ffprobe"""
...
def convert_times(times):
    ...
    new_times = []
    for t in times:
        # Doing manual math to convert seconds above 60 to minutes and seconds. Seems like there should be an easy function for this
        big_seconds = t.split(".")
...
def parse_file(file, times):
    ...
    for count, line in enumerate(content):
        ...
        if count % 2 == 0:
            ...
            # Compare time to time in times[time_arr_index]
